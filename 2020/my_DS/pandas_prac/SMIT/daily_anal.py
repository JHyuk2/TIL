...
## 실제 실행문
daily_0417 = read_myexcel('0417 Daily.xlsx')
daily_0418 = read_myexcel('0418 Daily.xlsx')
daily_0419 = read_myexcel('0419 Daily.xlsx')
daily_0420 = read_myexcel('0420 Daily.xlsx')
daily_0421 = read_myexcel('0421 Daily.xlsx')
daily_0422 = read_myexcel('0422 Daily.xlsx')
daily_0423 = read_myexcel('0423 Daily.xlsx')
...
daily_list.to_csv('output_1기.csv', header = True, encoding = 'utf-8-sig', index=False)